    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
            <!-- <div class="input-group"> 
                    <input class="form-control" type="text" placeholder="Search for..." arialabel="Search for..." aria-describedby="btnNavbarSearch" /> 
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="?page=ulasan">
                            <div class="sb-nav-link-icon"><i class="fas facomment"></i></div>
                            Ulasan
                        </a> <?php
                        if ($_SESSION['user']['level'] != 'peminjam') {
                            ?>
                        ...
                        <a class="nav-link" href="logout.php">
                            <div class="sb-nav-link-icon"><i class="fa fa-poweroff"></i></div>
                            Logout
                        </a>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Perpustakaan Digital
                            2024</div>
                        <div>
